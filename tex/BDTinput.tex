...
\put(-70, 70){\textbf{(b3)}}
\\
\caption{ The BDT input distributions for the background and merged signal in the STH $\thadhad$ (a1-3), TTH $\thadhad$ (b1-3)}% The Kolmogorov Test values for the training and testing BDT distributions are also indicated.
...
\put(-70, 70){\textbf{(b3)}}
\\
\caption{ The BDT input distributions for the background and merged signal in the STH $\tlhad$ (a1-3), TTH $\tlhad$ (b1-3). }% The Kolmogorov Test values for the training and testing BDT distributions are also indicated.
...
\put(-70, 70){\textbf{(c3)}}
\\
\caption{ The BDT input distributions for the background and merged signal in the $l\thadhad$ (a1-3), $l\thad$ 1j (b1-3), $l\thadhad$ 2j (c1-3) channels. }% The Kolmogorov Test values for the training and testing BDT distributions are also indicated.
